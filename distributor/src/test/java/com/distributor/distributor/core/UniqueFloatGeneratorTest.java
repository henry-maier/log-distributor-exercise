...
class UniqueFloatGeneratorTest {
  ...
  void testGenerateUniqueFloat_WithinRange() {
    ...
    LogAnalyzerServiceOuterClass.LogPacket logPacket1 =
        LogAnalyzerServiceOuterClass.LogPacket.newBuilder()
            .addLogMessages(
                LogAnalyzerServiceOuterClass.LogMessage.newBuilder()
                    .setMessage("Message 1")
                    .build())
            .build();
    LogAnalyzerServiceOuterClass.LogPacket logPacket2 =
        LogAnalyzerServiceOuterClass.LogPacket.newBuilder()
            .addLogMessages(
                LogAnalyzerServiceOuterClass.LogMessage.newBuilder()
  ...
  void testGenerateUniqueFloat_ExceptionHandling() {
    ...
    LogAnalyzerServiceOuterClass.LogPacket logPacket =
        Mockito.mock(LogAnalyzerServiceOuterClass.LogPacket.class);
